 ...
 */
package com.example.alldocumentreader.thirdpart.achartengine.chart;
...
import com.example.alldocumentreader.thirdpart.achartengine.renderers.BasicStroke;
...
import com.example.alldocumentreader.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer.Orientation;
...
public abstract class XYChart extends AbstractChart {
   ...
   * 
   *(non-Javadoc)
   * @see com.example.alldocumentreader.thirdpart.achartengine.chart.AbstractChart#setZoomRate(float)
   *
   */
  @Override
