...
import com.example.alldocumentreader.thirdpart.emf.data.BitmapInfoHeader;
import com.example.alldocumentreader.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.example.documentreader.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
