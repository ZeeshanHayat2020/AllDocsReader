 ...
 * 时间:              下午9:36:57
 */
package com.example.alldocumentreader.pdf;
...
import com.example.alldocumentreader.constant.PDFConstant;
import com.example.alldocumentreader.fc.pdf.PDFLib;
import com.example.alldocumentreader.simpletext.control.SafeAsyncTask;
...
//        if (control.getMainFrame().isShowProgressBar() || true)
    ...
    public void setPageItemRawData(final int pIndex, int pWidth, int pHeight)
    {
        ...
        if (originalImageView == null)
        {
            originalImageView = new AppCompatImageView(listView.getContext())
            {
...
//                }
        ...
        if (searchView == null)
        {
            ...
            addView(searchView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
        }
    }
    /**
     * 
...
//        }
    ...
    protected void addRepaintImageView(Bitmap bmp)
    {
                                           ...
                                           || originalBitmap.getHeight() != pageHeight)))
        {
            ...
            if (repaintImageView == null)
            {
                repaintImageView = new AppCompatImageView(listView.getContext())
                {
                    public boolean isOpaque()
                    {
                        return true;
