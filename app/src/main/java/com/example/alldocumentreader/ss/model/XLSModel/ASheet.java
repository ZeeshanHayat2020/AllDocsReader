 ...
 * 时间:              下午1:55:20
 */
package com.example.alldocumentreader.ss.model.XLSModel;
...
import com.example.alldocumentreader.common.shape.AChart;
...
import com.example.alldocumentreader.constant.SSConstant;
import com.example.alldocumentreader.fc.hssf.model.InternalSheet;
import com.example.alldocumentreader.fc.hssf.model.InternalWorkbook;
import com.example.alldocumentreader.fc.hssf.record.BlankRecord;
...
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFAutoShape;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFChart;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFChildAnchor;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFClientAnchor;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFFreeform;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFLine;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFPatriarch;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFPicture;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFPictureData;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFRichTextString;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFShape;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFShapeGroup;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFSheet;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFTextbox;
import com.example.alldocumentreader.fc.hssf.usermodel.HSSFWorkbook;
...
import com.example.alldocumentreader.fc.xls.ChartConverter;
import com.example.alldocumentreader.java.awt.Rectangle;
import com.example.alldocumentreader.ss.model.CellRangeAddress;
import com.example.alldocumentreader.ss.model.baseModel.Cell;
import com.example.alldocumentreader.ss.model.baseModel.Row;
import com.example.alldocumentreader.ss.model.baseModel.Sheet;
import com.example.alldocumentreader.ss.model.baseModel.Workbook;
import com.example.alldocumentreader.ss.model.drawing.AnchorPoint;
import com.example.alldocumentreader.ss.model.drawing.CellAnchor;
import com.example.alldocumentreader.ss.model.sheetProperty.PaneInformation;
import com.example.alldocumentreader.ss.util.ModelUtil;
import com.example.alldocumentreader.ss.util.SectionElementFactory;
...
import com.example.alldocumentreader.thirdpart.achartengine.chart.RoundChart;
import com.example.alldocumentreader.thirdpart.achartengine.chart.XYChart;
import com.example.alldocumentreader.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.example.alldocumentreader.fc.ss.usermodel.Sheet
{
     ...
     * @see com.example.alldocumentreader.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.example.alldocumentreader.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.example.alldocumentreader.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.example.alldocumentreader.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.example.alldocumentreader.ss.model.sheetProperty.ColumnInfo columnInfo = new com.example.alldocumentreader.ss.model.sheetProperty.ColumnInfo(
