    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.example.alldocumentreader.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
...
//            safeAsyncTask.execute((Void)null);
     ...
     * 
     *(non-Javadoc)
     * @see com.example.alldocumentreader.system.AbstractControl#getActivity()
     *
     */
