...
package com.example.alldocumentreader.fc.hslf.usermodel;
...
import com.example.alldocumentreader.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.example.alldocumentreader.fc.hslf.model.HeadersFooters;
import com.example.alldocumentreader.fc.hslf.model.Hyperlink;
import com.example.alldocumentreader.fc.hslf.model.MovieShape;
...
import com.example.alldocumentreader.fc.hslf.record.Document;
import com.example.alldocumentreader.fc.hslf.record.DocumentAtom;
import com.example.alldocumentreader.fc.hslf.record.ExAviMovie;
import com.example.alldocumentreader.fc.hslf.record.ExControl;
import com.example.alldocumentreader.fc.hslf.record.ExHyperlink;
import com.example.alldocumentreader.fc.hslf.record.ExHyperlinkAtom;
import com.example.alldocumentreader.fc.hslf.record.ExMCIMovie;
import com.example.alldocumentreader.fc.hslf.record.ExObjList;
import com.example.alldocumentreader.fc.hslf.record.ExObjListAtom;
import com.example.alldocumentreader.fc.hslf.record.ExOleObjAtom;
import com.example.alldocumentreader.fc.hslf.record.ExVideoContainer;
import com.example.alldocumentreader.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.example.alldocumentreader.fc.hslf.record.ExtendedPresRuleContainer;
import com.example.alldocumentreader.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.example.alldocumentreader.fc.hslf.record.FontCollection;
import com.example.alldocumentreader.fc.hslf.record.HeadersFootersContainer;
import com.example.alldocumentreader.fc.hslf.record.PersistPtrHolder;
import com.example.alldocumentreader.fc.hslf.record.PositionDependentRecord;
...
import com.example.alldocumentreader.fc.hslf.record.RecordContainer;
import com.example.alldocumentreader.fc.hslf.record.RecordTypes;
import com.example.alldocumentreader.fc.hslf.record.SlideListWithText;
import com.example.alldocumentreader.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.example.alldocumentreader.fc.hslf.record.SlidePersistAtom;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocumentreader.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.example.alldocumentreader.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.example.alldocumentreader.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.example.alldocumentreader.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.example.alldocumentreader.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.example.alldocumentreader.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.example.alldocumentreader.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.example.alldocumentreader.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocumentreader.fc.hslf.record.Notes)
                {
                    com.example.alldocumentreader.fc.hslf.record.Notes notesRecord = (com.example.alldocumentreader.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.example.alldocumentreader.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.example.alldocumentreader.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.example.alldocumentreader.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.example.alldocumentreader.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.example.alldocumentreader.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.example.alldocumentreader.fc.hslf.record.Slide)r;
                }
                /*else
                {
