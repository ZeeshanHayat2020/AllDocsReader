...
import com.example.alldocumentreader.fc.hssf.formula.ptg.TblPtg;
import com.example.alldocumentreader.fc.ss.util.CellReference;
import com.example.alldocumentreader.fc.util.LittleEndian;
import com.example.alldocumentreader.fc.util.LittleEndianByteArrayInputStream;
import com.example.alldocumentreader.fc.util.LittleEndianInput;
...
public class Formula {
	...
	/**
	 * Gets the locator for the corresponding {@link com.example.alldocumentreader.fc.hssf.record.SharedFormulaRecord},
     * {@link com.example.alldocumentreader.fc.hssf.record.ArrayRecord} or {@link com.example.alldocumentreader.fc.hssf.record.TableRecord}
