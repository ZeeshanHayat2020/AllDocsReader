...
package com.example.alldocumentreader.fc;

import com.example.alldocumentreader.fc.hpsf.DocumentSummaryInformation;
import com.example.alldocumentreader.fc.hpsf.MutablePropertySet;
import com.example.alldocumentreader.fc.hpsf.PropertySet;
import com.example.alldocumentreader.fc.hpsf.PropertySetFactory;
import com.example.alldocumentreader.fc.hpsf.SummaryInformation;
...
import com.example.alldocumentreader.fc.poifs.filesystem.DocumentInputStream;
import com.example.alldocumentreader.fc.poifs.filesystem.Entry;
import com.example.alldocumentreader.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.example.alldocumentreader.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.example.alldocumentreader.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.example.alldocumentreader.fc.hpsf.WritingNotSupportedException wnse)
        {
