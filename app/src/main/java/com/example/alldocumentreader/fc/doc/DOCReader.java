...
package com.example.alldocumentreader.fc.doc;
...
import com.example.alldocumentreader.common.bookmark.Bookmark;
import com.example.alldocumentreader.common.borders.Border;
import com.example.alldocumentreader.common.borders.Borders;
import com.example.alldocumentreader.common.borders.Line;
import com.example.alldocumentreader.common.bulletnumber.ListData;
import com.example.alldocumentreader.common.bulletnumber.ListLevel;
import com.example.alldocumentreader.common.hyperlink.Hyperlink;
import com.example.alldocumentreader.common.picture.Picture;
...
import com.example.alldocumentreader.common.shape.WPAbstractShape;
import com.example.alldocumentreader.common.shape.WPAutoShape;
import com.example.alldocumentreader.common.shape.WPGroupShape;
import com.example.alldocumentreader.common.shape.WPPictureShape;
...
import com.example.alldocumentreader.fc.ddf.EscherOptRecord;
import com.example.alldocumentreader.fc.ddf.EscherProperties;
import com.example.alldocumentreader.fc.ddf.EscherSimpleProperty;
import com.example.alldocumentreader.fc.ddf.EscherTextboxRecord;
import com.example.alldocumentreader.fc.hwpf.HWPFDocument;
import com.example.alldocumentreader.fc.hwpf.model.FieldsDocumentPart;
import com.example.alldocumentreader.fc.hwpf.model.ListFormatOverride;
import com.example.alldocumentreader.fc.hwpf.model.ListTables;
import com.example.alldocumentreader.fc.hwpf.model.POIListData;
import com.example.alldocumentreader.fc.hwpf.model.POIListLevel;
import com.example.alldocumentreader.fc.hwpf.model.PicturesTable;
import com.example.alldocumentreader.fc.hwpf.usermodel.Bookmarks;
import com.example.alldocumentreader.fc.hwpf.usermodel.BorderCode;
import com.example.alldocumentreader.fc.hwpf.usermodel.CharacterRun;
import com.example.alldocumentreader.fc.hwpf.usermodel.Field;
import com.example.alldocumentreader.fc.hwpf.usermodel.HWPFAutoShape;
import com.example.alldocumentreader.fc.hwpf.usermodel.HWPFShape;
import com.example.alldocumentreader.fc.hwpf.usermodel.HWPFShapeGroup;
import com.example.alldocumentreader.fc.hwpf.usermodel.HeaderStories;
import com.example.alldocumentreader.fc.hwpf.usermodel.InlineWordArt;
import com.example.alldocumentreader.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.example.alldocumentreader.fc.hwpf.usermodel.OfficeDrawing;
import com.example.alldocumentreader.fc.hwpf.usermodel.OfficeDrawings;
import com.example.alldocumentreader.fc.hwpf.usermodel.POIBookmark;
import com.example.alldocumentreader.fc.hwpf.usermodel.Paragraph;
import com.example.alldocumentreader.fc.hwpf.usermodel.PictureType;
import com.example.alldocumentreader.fc.hwpf.usermodel.Range;
import com.example.alldocumentreader.fc.hwpf.usermodel.Section;
import com.example.alldocumentreader.fc.hwpf.usermodel.Table;
import com.example.alldocumentreader.fc.hwpf.usermodel.TableCell;
import com.example.alldocumentreader.fc.hwpf.usermodel.TableRow;
import com.example.alldocumentreader.fc.util.LittleEndian;
import com.example.alldocumentreader.java.awt.Rectangle;
import com.example.alldocumentreader.java.util.Arrays;
...
import com.example.alldocumentreader.simpletext.view.PageAttr;
import com.example.alldocumentreader.ss.util.ModelUtil;
import com.example.alldocumentreader.system.AbstractReader;
import com.example.alldocumentreader.system.IControl;
import com.example.alldocumentreader.wp.model.CellElement;
import com.example.alldocumentreader.wp.model.HFElement;
import com.example.alldocumentreader.wp.model.RowElement;
import com.example.alldocumentreader.wp.model.TableElement;
import com.example.alldocumentreader.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.example.alldocumentreader.java.awt.Color fillColor = shape.getForegroundColor();
            	com.example.alldocumentreader.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.example.alldocumentreader.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.example.alldocumentreader.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
