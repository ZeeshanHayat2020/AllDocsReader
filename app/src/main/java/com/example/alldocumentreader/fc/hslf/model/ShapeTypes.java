 ...
 * @author Yegor Kozlov
 */
public final class ShapeTypes implements com.example.alldocumentreader.common.shape.ShapeTypes
{
    /**
    ...
    static
    {
        ...
        try
        {
            Field[] f = com.example.alldocumentreader.common.shape.ShapeTypes.class.getFields();
