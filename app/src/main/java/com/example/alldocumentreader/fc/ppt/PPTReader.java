 ...
 * 时间:               下午4:23:51
 */
package com.example.alldocumentreader.fc.ppt;
...
import com.example.alldocumentreader.common.PaintKit;
import com.example.alldocumentreader.common.autoshape.ExtendPath;
import com.example.alldocumentreader.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.example.alldocumentreader.common.bg.BackgroundAndFill;
import com.example.alldocumentreader.common.bg.Gradient;
import com.example.alldocumentreader.common.bg.LinearGradientShader;
import com.example.alldocumentreader.common.bg.RadialGradientShader;
import com.example.alldocumentreader.common.bg.TileShader;
import com.example.alldocumentreader.common.hyperlink.Hyperlink;
import com.example.alldocumentreader.common.pictureefftect.PictureEffectInfoFactory;
import com.example.alldocumentreader.common.shape.AbstractShape;
import com.example.alldocumentreader.common.shape.ArbitraryPolygonShape;
import com.example.alldocumentreader.common.shape.Arrow;
import com.example.alldocumentreader.common.shape.AutoShape;
import com.example.alldocumentreader.common.shape.GroupShape;
import com.example.alldocumentreader.common.shape.IShape;
import com.example.alldocumentreader.common.shape.LineShape;
import com.example.alldocumentreader.common.shape.PictureShape;
import com.example.alldocumentreader.common.shape.ShapeTypes;
import com.example.alldocumentreader.common.shape.TableCell;
import com.example.alldocumentreader.common.shape.TableShape;
import com.example.alldocumentreader.common.shape.TextBox;
import com.example.alldocumentreader.constant.AutoShapeConstant;
import com.example.alldocumentreader.constant.EventConstant;
import com.example.alldocumentreader.constant.MainConstant;
import com.example.alldocumentreader.constant.wp.WPAttrConstant;
import com.example.alldocumentreader.constant.wp.WPModelConstant;
import com.example.alldocumentreader.fc.FCKit;
import com.example.alldocumentreader.fc.ShapeKit;
import com.example.alldocumentreader.fc.hslf.HSLFSlideShow;
import com.example.alldocumentreader.fc.hslf.model.Fill;
import com.example.alldocumentreader.fc.hslf.model.HeadersFooters;
import com.example.alldocumentreader.fc.hslf.model.Line;
import com.example.alldocumentreader.fc.hslf.model.MasterSheet;
import com.example.alldocumentreader.fc.hslf.model.Notes;
import com.example.alldocumentreader.fc.hslf.model.Shape;
import com.example.alldocumentreader.fc.hslf.model.ShapeGroup;
import com.example.alldocumentreader.fc.hslf.model.Sheet;
import com.example.alldocumentreader.fc.hslf.model.SimpleShape;
import com.example.alldocumentreader.fc.hslf.model.Slide;
import com.example.alldocumentreader.fc.hslf.model.SlideMaster;
import com.example.alldocumentreader.fc.hslf.model.TextShape;
import com.example.alldocumentreader.fc.hslf.model.TitleMaster;
import com.example.alldocumentreader.fc.hslf.record.BinaryTagDataBlob;
import com.example.alldocumentreader.fc.hslf.record.ClientVisualElementContainer;
import com.example.alldocumentreader.fc.hslf.record.DocumentAtom;
import com.example.alldocumentreader.fc.hslf.record.OEPlaceholderAtom;
import com.example.alldocumentreader.fc.hslf.record.PositionDependentRecordContainer;
import com.example.alldocumentreader.fc.hslf.record.Record;
import com.example.alldocumentreader.fc.hslf.record.SlideAtom;
import com.example.alldocumentreader.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.example.alldocumentreader.fc.hslf.record.SlideProgBinaryTagContainer;
import com.example.alldocumentreader.fc.hslf.record.SlideProgTagsContainer;
import com.example.alldocumentreader.fc.hslf.record.SlideShowSlideInfoAtom;
import com.example.alldocumentreader.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeColorBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeCommandBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeEffectBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeMotionBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeNodeAttributeContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeNodeContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeRotationBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeScaleBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeSetBehaviorContainer;
import com.example.alldocumentreader.fc.hslf.record.TimeVariant;
import com.example.alldocumentreader.fc.hslf.record.VisualShapeAtom;
import com.example.alldocumentreader.fc.hslf.usermodel.PictureData;
import com.example.alldocumentreader.fc.hslf.usermodel.RichTextRun;
import com.example.alldocumentreader.fc.hslf.usermodel.SlideShow;
import com.example.alldocumentreader.fc.ppt.bulletnumber.BulletNumberManage;
import com.example.alldocumentreader.java.awt.Dimension;
import com.example.alldocumentreader.java.awt.Rectangle;
import com.example.alldocumentreader.java.awt.Rectanglef;
import com.example.alldocumentreader.java.awt.geom.Rectangle2D;
import com.example.alldocumentreader.pg.animate.ShapeAnimation;
import com.example.alldocumentreader.pg.model.PGModel;
import com.example.alldocumentreader.pg.model.PGNotes;
import com.example.alldocumentreader.pg.model.PGSlide;
import com.example.alldocumentreader.simpletext.font.FontTypefaceManage;
import com.example.alldocumentreader.simpletext.model.AttrManage;
import com.example.alldocumentreader.simpletext.model.IAttributeSet;
import com.example.alldocumentreader.simpletext.model.LeafElement;
import com.example.alldocumentreader.simpletext.model.ParagraphElement;
import com.example.alldocumentreader.simpletext.model.SectionElement;
import com.example.alldocumentreader.ss.util.format.NumericFormatter;
import com.example.alldocumentreader.system.AbstractReader;
import com.example.alldocumentreader.system.BackReaderThread;
...
{   
    ...
    private com.example.alldocumentreader.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.example.alldocumentreader.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.example.alldocumentreader.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.example.alldocumentreader.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.example.alldocumentreader.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.example.alldocumentreader.java.awt.Color fillColor = fill.getForegroundColor();
            	com.example.alldocumentreader.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.example.alldocumentreader.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.example.alldocumentreader.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.example.alldocumentreader.fc.hslf.model.Freeform
            || shape instanceof com.example.alldocumentreader.fc.hslf.model.AutoShape
            || shape instanceof com.example.alldocumentreader.fc.hslf.model.TextBox
            || shape instanceof com.example.alldocumentreader.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.example.alldocumentreader.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.example.alldocumentreader.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.example.alldocumentreader.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.example.alldocumentreader.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.example.alldocumentreader.fc.hslf.model.AutoShape
                    || shape instanceof com.example.alldocumentreader.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.example.alldocumentreader.fc.hslf.model.Picture)
            {   
                com.example.alldocumentreader.fc.hslf.model.Picture poiPic = (com.example.alldocumentreader.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.example.alldocumentreader.fc.hslf.model.Table)
        {
            com.example.alldocumentreader.fc.hslf.model.Table poiTable = (com.example.alldocumentreader.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.example.alldocumentreader.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.example.alldocumentreader.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.example.alldocumentreader.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.example.alldocumentreader.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.example.alldocumentreader.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.example.alldocumentreader.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.example.alldocumentreader.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.example.alldocumentreader.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.example.alldocumentreader.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
