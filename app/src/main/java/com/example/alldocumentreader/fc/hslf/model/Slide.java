...
import com.example.alldocumentreader.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.example.alldocumentreader.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.example.alldocumentreader.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.example.alldocumentreader.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.example.alldocumentreader.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.example.alldocumentreader.fc.hslf.record.Slide)getSheetContainer();
    }
