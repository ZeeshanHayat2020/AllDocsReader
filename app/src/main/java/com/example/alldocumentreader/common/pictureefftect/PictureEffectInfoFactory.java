 ...
 * 时间:              上午9:08:14
 */
package com.example.alldocumentreader.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.example.alldocumentreader.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
