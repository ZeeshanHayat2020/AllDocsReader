    ...
    implements Shape, java.io.Serializable
{
     ...
     * @see       #getBounds
     * @see	  java.awt.Component#setBounds(com.example.alldocumentreader.java.awt.Rectangle)
     * @since     1.1
     */
     ...
     *                 along the Y axis
     * @see       com.example.alldocumentreader.java.awt.Rectangle#setLocation(int, int)
     * @see       com.example.alldocumentreader.java.awt.Rectangle#setLocation(java.awt.Point)
     */
     ...
     * @see       java.awt.Component#setSize(com.example.alldocumentreader.java.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
