...
package com.example.alldocumentreader.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link com.example.alldocumentreader.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link com.example.alldocumentreader.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see com.example.alldocumentreader.fc.hwpf.usermodel.Shape
 * @see com.example.alldocumentreader.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
