...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.xls.Reader.drawing.DrawingReader;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.xls.Reader.table.TableReader;
...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.util.ReferenceUtil;
...
public class SheetReader {
    ...
    private void setColumnProperty(Element col) {
        ...
        if (col.attributeValue("hidden") != null ) {
            ...
            String s = col.attributeValue("hidden");
            Log.d("SheetReader", "col.attributeValue:" + s);
    ...
    private Row createRow(Element rowElement, int defaultRowHeight) {
        ...
        if (rowElement.attributeValue("hidden") != null) {
            ...
            String s = rowElement.attributeValue("hidden");
            Log.d("SheetReader", "CreateRow. rowElement.attributeValue:" + s);
            if (s.contains("true") || s.contains("false")) {
                boolean bool = Boolean.parseBoolean(s);
                hidden = bool;
            }
    ...
    private void modifyRow(Row row, Element rowElement, int defaultRowHeight) {
        ...
        if (rowElement.attributeValue("hidden") != null ) {
            ...
            String s = rowElement.attributeValue("hidden");
            Log.d("SheetReader", "rowElement.attributeValue:" + s);
