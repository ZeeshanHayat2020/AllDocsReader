...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.model.Hyperlink;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.model.MovieShape;
...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExAviMovie;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExControl;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExHyperlink;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExHyperlinkAtom;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExMCIMovie;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExObjList;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExObjListAtom;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExOleObjAtom;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExVideoContainer;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExtendedPresRuleContainer;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.FontCollection;
...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.PositionDependentRecord;
...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.SlideListWithText;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.SlidePersistAtom;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes)
                {
                    com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes notesRecord = (com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.fc.hslf.record.Slide)r;
                }
                /*else
                {
