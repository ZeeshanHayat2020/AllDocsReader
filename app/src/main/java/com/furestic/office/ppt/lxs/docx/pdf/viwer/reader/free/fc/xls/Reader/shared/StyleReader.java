...
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.style.BorderStyle;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.style.BuiltinFormats;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.style.CellBorder;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.style.CellStyle;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.style.NumberFormat;
import com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.ss.model.table.TableFormatManager;
...
public class StyleReader {
    ...
    private void processCellStyleAlignment(CellStyle cellStyle, Element alignment) {
        ...
        if (alignment.attributeValue("wrapText") != null) {
            String s = alignment.attributeValue("wrapText");
            Log.d("Style Reader", "WrapText:" + s);

            if (s.contains("true") || s.contains("false")) {
                boolean bool = Boolean.parseBoolean(s);
                cellStyle.setWrapText(bool);
            }
        } else {
