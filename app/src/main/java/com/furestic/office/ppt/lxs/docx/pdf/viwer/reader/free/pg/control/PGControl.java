    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
...
//            safeAsyncTask.execute((Void)null);
     ...
     * 
     *(non-Javadoc)
     * @see com.furestic.office.ppt.lxs.docx.pdf.viwer.reader.free.system.AbstractControl#getActivity()
     *
     */
